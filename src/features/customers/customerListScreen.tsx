    ...
    <div>
      ...
      <div className="px-[80px] py-[20px]">
        <div className="flex gap-[40px] mb-4"> 
          ...
          />
          <Button type="submit" variant="default" className="w-auto shadow-md rounded-xl" onClick={()=>navigate('/cadastroCliente')}>
            Cadastrar Cliente
          </Button>
        </div>
        ...
        <Table className="bg-white rounded-3xl">
          ...
          <TableBody>
            {filteredData?.map((user: IGetAllCustomersResponse) => (
              <TableRow key={user.id} className="h-[50px] text-neutral-500">
